...
return new class extends Migration
{
    ...
    {
        Schema::create('patient_follow_up_form_anti_cancer_drug_therapies', function (Blueprint $table) {
            $table->id();
            $table->foreignId('patient_follow_up_form_id')
                ->constrained(indexName: 'pfuf_acdt_fk')
                ->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('patient_follow_up_form_anti_cancer_drug_therapies');
    }
};
