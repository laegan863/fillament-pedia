                            ...
                            */
                            ...
                            Actions::make([
                                ...
                                Action::make('treatmentAntiCancerDrugTherapy')
                                    ...
                                    ->fillForm(fn (Get $get): array => [
                                        'radiotherapies' => filled($get('radiotherapies')) ? $get('radiotherapies') : [[]],
                                    ])
                                    ->action(function (array $data, Set $set): void {
                                    ...
                                    ->fillForm(fn (Get $get): array => [
                                        'details' => $get('theranostics_details'),
                                        'notes' => $get('theranostics_notes'),
                                    ])
                                    ->action(function (array $data, Set $set): void {
                                        $set('theranostics_details', $data['details']);
                                        $set('theranostics_notes', $data['notes'] ?? null);
                                    }),
                                ...
                                Action::make('treatmentPalliativeCare')
                                    ...
                                    ->fillForm(fn (Get $get): array => [
                                        'details' => $get('palliative_care_details'),
                                        'notes' => $get('palliative_care_notes'),
                                    ])
                                    ->action(function (array $data, Set $set): void {
                                        $set('palliative_care_details', $data['details']);
                                        $set('palliative_care_notes', $data['notes'] ?? null);
                                    }),
